...
export const TRANSLATIONS = {
  en: {
    ...
    filterAll: 'All',
    filterPinned: 'Pinned',
    filterWithKeys: 'With keys',
    filterNoKeys: 'No keys',
    filterCustom: 'Custom',
    ...
    restore: 'Restore',
    deletedProviders: 'Deleted providers',
    deletedKeys: 'Deleted keys',
    toastRestored: 'Restored',
    toastTrashed: 'Moved to recycle bin',
    toastEmptied: 'Recycle bin emptied',
    confirmEmptyTrash: 'Permanently delete ALL items in the recycle bin?',
    confirmPurge: 'Permanently delete "{name}"? This cannot be undone.',

    // Key tester
    keyTestTitle: 'Test API Keys',
    testKey: 'Test',
    ...
    testModel: 'Model (optional)',
    testAll: 'Test all',
    testResults: 'Results',
    corsHint: 'Note: some providers block browser (CORS) requests — a network error does not always mean the key is bad.',
  ...
  fa: {
    ...
    filterAll: 'همه',
    filterPinned: 'پین‌شده',
    filterWithKeys: 'دارای کلید',
    filterNoKeys: 'بدون کلید',
    filterCustom: 'سفارشی',
    sortPinned: 'پین‌شده اول',
    sortName: 'نام (الف→ی)',
    sortKeys: 'بیشترین کلید',
    sortNewest: 'جدیدترین',
    pin: 'سنجاق به بالا',
    unpin: 'برداشتن سنجاق',
    pinned: 'پین‌شده',

    trashTitle: 'سطل بازیافت',
    trashEmpty: 'سطل بازیافت خالی است.',
    emptyTrash: 'خالی کردن سطل',
    restore: 'بازیابی',
    deletedProviders: 'پرووایدرهای حذف‌شده',
    deletedKeys: 'کلیدهای حذف‌شده',
    toastRestored: 'بازیابی شد',
    toastTrashed: 'به سطل بازیافت منتقل شد',
    toastEmptied: 'سطل بازیافت خالی شد',
    confirmEmptyTrash: 'همه موارد سطل بازیافت برای همیشه حذف شوند؟',
    confirmPurge: '«{name}» برای همیشه حذف شود؟ قابل بازگشت نیست.',

    keyTestTitle: 'تست کلیدهای API',
    testKey: 'تست',
    testAllKeys: '🧪 تست همه کلیدها',
    testThisKey: 'تست این کلید',
    testing: 'در حال تست…',
    keyValid: 'کلید معتبر است',
    keyInvalid: 'کلید نامعتبر',
    testModel: 'مدل (اختیاری)',
    testAll: 'تست همه',
    testResults: 'نتایج',
    corsHint: 'توجه: بعضی پرووایدرها درخواست مرورگر (CORS) را مسدود می‌کنند — خطای شبکه همیشه به معنای بد بودن کلید نیست.',
